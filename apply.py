...
def greenhouse(driver):
    ...
    driver.find_element_by_css_selector("#job_application_answers_attributes_7_text_value").send_keys("Passionate to build product which would have a good impact to humanity using technology with professional and academic experience.")
    ...
    try:
        interviewed =  driver.find_element_by_css_selector("#s2id_job_application_answers_attributes_8_boolean_value > a > span.select2-chosen")
        driver.find_element_by_css_selector("#s2id_job_application_answers_attributes_8_boolean_value > a > span.select2-arrow > b").click()
